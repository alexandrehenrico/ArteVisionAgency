    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl border border-blue-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-blue-900">Checklist de Atividades</h3>
        ...
        <div className="text-right">
          <div className="text-2xl font-bold text-blue-900">{Math.round(progresso)}%</div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <h4 className={`font-medium ${
                      atividade.concluida ? 'line-through text-muted-foreground' : 'text-blue-900'
                    }`}>
                      {atividade.titulo}
                    </h4>
                  ...
                  {atividade.descricao && (
                    <p className={`text-sm mb-2 ${
                      atividade.concluida ? 'text-muted-foreground' : 'text-blue-600'
                    }`}>
                      {atividade.descricao}
                    </p>
                  )}
