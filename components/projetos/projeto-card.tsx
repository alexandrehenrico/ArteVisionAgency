      ...
      <CardContent className="pt-0 space-y-4">
        ...
        {cliente && (
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-blue-700 font-medium">{cliente.nome}</span>
          </div>
        )}
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-blue-700">Início: {formatDate(projeto.dataInicio)}</span>
          </div>
          ...
          {projeto.dataPrevisao && (
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-blue-700">Previsão: {formatDate(projeto.dataPrevisao)}</span>
              </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-blue-700">Atividades: {atividadesConcluidas}/{totalAtividades}</span>
              </div>
              <span className="text-sm font-medium text-blue-700">{Math.round(progressoAtividades)}%</span>
            </div>
