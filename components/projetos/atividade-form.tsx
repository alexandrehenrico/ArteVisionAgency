  ...
  if (!showForm) {
    return (
      <Button
        ...
        variant="outline"
        size="sm"
        className="w-full border-dashed border-2 hover:bg-blue-50 transition-colors duration-200"
      >
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-lg font-bold text-blue-900">Nova Atividade</CardTitle>
          </div>
          <Button
            variant="ghost"
            size="sm"
