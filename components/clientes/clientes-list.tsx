    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-xl font-bold text-blue-900">Lista de Clientes</h2>
        </div>
      ...
      {clientesFiltrados.length === 0 ? (
        <div className="text-center py-16 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
