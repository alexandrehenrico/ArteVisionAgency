...
export function ClienteCard({ cliente, onClick, className }: ClienteCardProps) {
  ...
  return (
    <Card
      className={`relative overflow-hidden bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 p-6 transition-all duration-200 hover:shadow-md ${
    ...
    >
      ...
      <div className="relative flex items-center gap-4 mb-4">
        ...
        <div className="relative flex items-center justify-center h-14 w-14 rounded-full bg-gradient-to-br from-blue-800 to-black text-white font-bold shadow-md">
          {getInitials(cliente.nome)}
        </div>

        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <h2 className="text-xl font-bold text-blue-900 truncate">{cliente.nome}</h2>
      ...
      <div className="space-y-2 mb-4">
        <h4 className="font-semibold text-blue-900">Serviço Prestado</h4>
      ...
      <div className="space-y-2 mb-4">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="truncate text-blue-700">{cliente.email}</span>
        </div>
      ...
      {cliente.registradoPor && (
        <div className="pt-3 border-t border-blue-100 mb-4">
      ...
      <div className="flex gap-2 pt-2">
        ...
        <Button
          ...
          variant="outline"
          size="sm"
          className="flex-1 transition-colors duration-200 hover:bg-blue-50"
        >
