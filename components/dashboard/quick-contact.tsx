    ...
    return (
      <Card className={className}>
        <CardContent className="flex flex-col items-center justify-center py-12 px-6 text-center">
          ...
          <h3 className="font-medium text-blue-900 mb-2">Nenhum cliente ainda</h3>
      ...
      <Card className={`${className || ''}`}>
        ...
        <CardContent className="space-y-2 px-3 py-4">
          {clientesRecentes.map((cliente) => (
            <div key={cliente.id} className="flex items-center gap-2 p-3 hover:bg-blue-50 rounded-lg transition-colors duration-200">
              <Avatar className="h-10 w-10 flex-shrink-0">
                <AvatarImage src={undefined} />
                <AvatarFallback className="text-xs bg-gradient-to-br from-blue-800 to-black text-white">
      ...
      <CardContent>
        <div className="space-y-3">
          {clientesRecentes.map((cliente, index) => (
            <div 
              key={cliente.id} 
              className="group bg-gradient-to-r from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 rounded-xl border border-blue-200 transition-all duration-200 hover:shadow-sm"
            >
              {/* Layout Desktop */}
                ...
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <p className="font-semibold text-sm text-blue-900 truncate">{cliente.nome}</p>
                      {index === 0 && (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 mb-2">
                      <p className="font-semibold text-base sm:text-sm text-blue-900 truncate">{cliente.nome}</p>
                      {index === 0 && (
