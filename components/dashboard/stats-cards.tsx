    ...
    <div className={`grid gap-4 md:grid-cols-2 lg:grid-cols-4 ${className || ''}`}>
      {cards.map((card) => (
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-blue-100 to-blue-200 rounded-full opacity-20 -translate-y-12 translate-x-12 group-hover:scale-110 transition-transform duration-200" />
          ...
          <CardContent className="space-y-3">
            <div className="flex items-end justify-between">
              <div className="text-2xl font-bold text-blue-900 group-hover:text-black transition-colors duration-200">
                {card.value}
              </div>
            </div>
