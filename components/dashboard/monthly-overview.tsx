    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-white p-4 border border-blue-200 rounded-lg shadow-lg">
          <p className="font-semibold text-blue-900 mb-2">{`${data.fullMonth} ${data.year}`}</p>
    ...
    return (
      <Card className={className}>
        <CardContent className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <h3 className="font-semibold text-blue-900 mb-2">Nenhum dado financeiro</h3>
  ...
  return (
    <Card className={`transition-all duration-200 hover:shadow-md ${className || ''}`}>
      <CardHeader className="pb-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-blue-900">Visão Geral Mensal</CardTitle>
      ...
      <CardContent className="space-y-6">
        {/* Estatísticas Resumo */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl border border-blue-200">
