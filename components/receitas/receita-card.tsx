...
export function ReceitaCard({ receita, cliente, onClick, className }: ReceitaCardProps) {
  ...
  const getCategoriaColor = (categoria: string) => {
    const colors: Record<string, string> = {
      ...
      Outros: "bg-blue-100 text-blue-800 border-blue-200",
    }
    return colors[categoria] || "bg-blue-100 text-blue-800 border-blue-200"
  }
      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            <h3 className="font-semibold text-sm leading-tight text-blue-900 truncate">
              {receita.descricao}
            </h3>
          </div>
