    ...
    <>
      ...
      <div className="lg:hidden fixed top-4 left-4 z-50">
        <button
          ...
          className="p-2 rounded-md bg-white shadow-md border border-blue-200 hover:bg-blue-50 transition"
        >
      ...
      <div
        className={cn(
          "fixed inset-y-0 left-0 z-40 w-64 bg-gradient-to-br from-blue-50 to-blue-100 border-r border-blue-200 transform transition-transform duration-200 ease-in-out lg:translate-x-0",
          isOpen ? "translate-x-0" : "-translate-x-full"
        )}
      >
        <div className="flex flex-col h-full relative overflow-hidden">
          {/* Decorações de fundo */}
          <div className="absolute top-0 right-0 w-32 h-32 bg-blue-900 rounded-full opacity-10 -translate-y-16 translate-x-16" />
          ...
          <div className="relative flex flex-col items-center justify-center px-4 py-6 border-b border-blue-200 z-10">
            ...
            <div className="text-center">
              <h1 className="text-sm font-semibold text-blue-900">Sistema de Gestão</h1>
              <p className="text-xs text-blue-600">Interno Arte Vision Agency</p>
            </div>
          </div>
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "bg-blue text-blue"
                      : "text-blue-600 hover:bg-blue-300 hover:text-blue-900"
                  )}
                >
          ...
          <div className="relative px-4 py-4 border-t border-blue-200 z-10 bg-white/70 backdrop-blur-md">
      ...
      {/* Overlay mobile */}
      {isOpen && <div className="fixed inset-0 z-30 bg-blue/50 lg:hidden" onClick={() => setIsOpen(false)} />}
    </>
  )
}
