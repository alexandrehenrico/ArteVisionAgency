...
export function ReciboForm({ onReciboAdicionado }: ReciboFormProps) {
  ...
  return (
    <Card className="relative overflow-hidden bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 shadow-sm">
      {/* Decorações de fundo */}
      <div className="absolute top-0 right-0 w-40 h-40 bg-blue-300 rounded-full opacity-10 -translate-y-20 translate-x-20" />
      ...
      <CardHeader className="relative">
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-xl font-bold text-blue-900">Criar Novo Recibo</CardTitle>
        </div>
      ...
      <CardContent className="relative">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Dados do Pagamento */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-blue-900">Dados do Pagamento</h3>
