  ...
  return (
    ...
    >
      ...
      <CardContent className="pt-0 space-y-4">
        ...
        <div className="bg-white rounded-lg p-3 border border-blue-200 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <div className="text-xs text-blue-500 uppercase font-medium">Valor Pago</div>
        ...
        {/* Serviço */}
        <div className="bg-white rounded-lg p-3 border border-blue-200 shadow-sm">
          <div className="text-xs text-blue-500 uppercase font-medium mb-2">Serviço Prestado</div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white rounded-lg p-3 border border-blue-200 shadow-sm">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-xs text-blue-500 uppercase font-medium">Pagamento</div>
                <div className="text-sm font-bold text-blue-900">{formatDate(recibo.dataPagamento)}</div>
              </div>
            </div>
          </div>
          ...
          {recibo.dataVencimento && (
            <div className="bg-white rounded-lg p-3 border border-blue-200 shadow-sm">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-xs text-blue-500 uppercase font-medium">Vencimento</div>
                  <div className="text-sm font-bold text-blue-900">{formatDate(recibo.dataVencimento)}</div>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="bg-white rounded-lg p-3 border border-blue-200 shadow-sm">
          <div className="flex items-center justify-between">
            <div className="text-xs text-blue-500 uppercase font-medium mb-1">Status do Recibo</div>
          </div>
          <Select
            value={recibo.status}
          ...
          <div className="pt-3 border-t border-blue-100">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-blue-500">
                Criado por <span className="font-bold text-blue-700">{recibo.registradoPor}</span>
              </span>
            </div>
          </div>
        )}
        ...
        <div className="grid grid-cols-2 gap-2 pt-2">
          <Button
            ...
            className="bg-white hover:bg-blue-50 border-blue-200 hover:border-blue-300 font-medium"
            disabled={loading}
          >
            <Download className="h-4 w-4 mr-2" />
            PDF
