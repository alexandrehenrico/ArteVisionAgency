  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-6">
        ...
        <div className="flex items-center justify-between p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 shadow-sm">
          <div>
            <p className="text-sm font-medium text-blue-700">Rascunho</p>
            <p className="text-2xl font-bold text-blue-600">{stats.rascunho}</p>
          </div>
        </div>
      ...
      {orcamentosFiltrados.length === 0 ? (
        <div className="text-center py-12 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
