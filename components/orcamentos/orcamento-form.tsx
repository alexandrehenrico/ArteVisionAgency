    ...
    <Card className="relative overflow-hidden bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 shadow-sm">
      <CardHeader className="relative">
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-xl font-bold text-blue-900">Criar Novo Orçamento</CardTitle>
        </div>
      ...
      <CardContent className="relative">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Dados do Projeto */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-blue-900">Dados do Projeto</h3>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-blue-900">Itens do Orçamento</h3>
