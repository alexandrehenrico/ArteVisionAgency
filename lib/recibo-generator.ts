...
export const gerarPDFRecibo = (recibo: Recibo) => {
  ...
  pdf.text('Arte Vision Agency', margin, yPosition)
  
  pdf.setFontSize(10)
  pdf.setFont('helvetica', 'normal')
  pdf.text('Soluções em Desenvolvimento Web, Desktop & Mobile', margin, yPosition + 12)
  pdf.text('Arte Vision Agencyma@gmail.com • (99) 98468-0391', margin, yPosition + 22)
  ...
  pdf.setFontSize(10)
  pdf.text('Arte Vision Agency', pageWidth - 70, yPosition + 10, { align: 'center' })
  ...
  pdf.text('Arte Vision Agencyma.com', pageWidth - 40, footerY)
...
export const gerarWordRecibo = (recibo: Recibo) => {
  ...
  const wordContent = `Arte Vision Agency
Soluções em Desenvolvimento Web, Desktop & Mobile
Arte Vision Agencyma@gmail.com • (99) 98468-0391
...
Arte Vision Agency - Desenvolvedora de Software
Gerado em ${new Date().toLocaleString('pt-BR')}
Arte Vision Agencyma.com`
